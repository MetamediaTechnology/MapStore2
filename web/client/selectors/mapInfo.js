...
export const measureActiveSelector = (state) => get(state, "controls.measure.enabled") && (get(state, "measurement.lineMeasureEnabled") || get(state, "measurement.areaMeasureEnabled") || get(state, "measurement.areaCircleEnabled") || get(state, "measurement.bearingMeasureEnabled"));
/**
